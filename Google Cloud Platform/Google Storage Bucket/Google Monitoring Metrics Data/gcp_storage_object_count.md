...
The API is used to retrieve the number of attempts to exceed the limit on quota metric storage.googleapis.com/storage/object_count.
...
* <b>GCP Original Name</b>: storage/object_count
