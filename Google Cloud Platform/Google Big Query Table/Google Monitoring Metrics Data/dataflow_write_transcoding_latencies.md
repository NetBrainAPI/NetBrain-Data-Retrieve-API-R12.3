...
The API is used to retrieve the duration distribution (in milliseconds) in BigQuery Write API frontend taken by transcoding data.
...
* <b>GCP Original Name</b>: dataflow_write/transcoding_latencies 
