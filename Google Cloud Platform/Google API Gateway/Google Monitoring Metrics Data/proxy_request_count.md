...
The API is used to retrieve the number of requests served by API gateway.

It leverages the GCP Cloud monitoring to fetch metrics of GCP resources via the GCP RESTful API. 

# Metric Info <a name="metric-info"></a>
* <b>Resource Label Used</b>: ID of the Gateway (gateway_id)
* <b>GCP Original Name</b>: proxy/request_count
