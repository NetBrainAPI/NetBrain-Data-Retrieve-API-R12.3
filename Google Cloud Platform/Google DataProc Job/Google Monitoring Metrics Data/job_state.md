...
The API is used to indicate the current state of the job.<br>
`True` - currently in state <br>
`False` - exited out of state.

It leverages the GCP Cloud monitoring to fetch metrics of GCP resources via the GCP RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Resource Label Used</b>: ID of the DataProc Job (job_id)
* <b>GCP Original Name</b>: job/state
