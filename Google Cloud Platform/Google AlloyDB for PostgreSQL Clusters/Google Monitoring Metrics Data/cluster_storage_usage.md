...
The API is used to retrieve the total AlloyDB storage in bytes across the entire cluster.

It leverages the GCP Cloud monitoring to fetch metrics of GCP resources via the GCP RESTful API. 

# Metric Info <a name="metric-info"></a>
* <b>Resource Label Used</b>: VPC Network cluster ID (cluster_id).
* <b>GCP Original Name</b>: cluster/storage/usage
