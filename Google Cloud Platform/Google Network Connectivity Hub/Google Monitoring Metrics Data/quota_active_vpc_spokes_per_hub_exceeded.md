...
The API is used to retrieve total number of attempts to exceed the limit on quota metric.

It leverages the GCP Cloud monitoring to fetch metrics of GCP resources via the GCP RESTful API.
# Metric Info <a name="metric-info"></a>
* <b>Resource Label Used</b>: Hub ID (hub_id)
* <b>GCP Original Name</b>: quota/active_vpc_spokes_per_hub/exceeded
