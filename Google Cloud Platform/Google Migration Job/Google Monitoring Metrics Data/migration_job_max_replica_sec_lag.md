...
The API is used to retrieve the current replication lag, aggregated across all of the migration job's data.
...
* <b>GCP Original Name</b>: migration_job/max_replica_sec_lag
