...
The API is used to retrieve TTL expiration to deletion delays metric.

It leverages the GCP Cloud monitoring to fetch metrics of GCP resources via the GCP RESTful API.
# Metric Info <a name="metric-info"></a>
* <b>Resource Label Used</b>: Database ID (database_id)
* <b>GCP Original Name</b>: document/ttl_expiration_to_deletion_delays
