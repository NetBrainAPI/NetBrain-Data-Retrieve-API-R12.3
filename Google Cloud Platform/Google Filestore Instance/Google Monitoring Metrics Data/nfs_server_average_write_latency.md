...
The API is used to retrieve the average latency for all disk write operations. This metric is not populated for basic tier instances.
...
* <b>GCP Original Name</b>: nfs/server/average_write_latency
