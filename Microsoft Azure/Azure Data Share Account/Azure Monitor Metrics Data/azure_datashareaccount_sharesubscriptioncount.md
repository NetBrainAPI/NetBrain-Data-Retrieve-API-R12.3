...
The API is used to retrieve Azure Data Share Account <b>ShareSubscriptionCount</b> metric data from Azure API Server (https://management.azure.com/). The metric is the number of received shares in the account.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: ShareSubscriptionCount
* <b>NetBrain Display Name</b>: Received Shares
* <b>Unit</b>: Count
