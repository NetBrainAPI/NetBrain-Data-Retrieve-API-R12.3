...
The API is used to retrieve Azure Container Instance Group <b>CpuUsage</b> metric data from Azure API Server (https://management.azure.com/). The metric is CPU usage on all cores in millicores.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: CpuUsage
* <b>NetBrain Display Name</b>: Cpu Usage
* <b>Unit</b>: Count
