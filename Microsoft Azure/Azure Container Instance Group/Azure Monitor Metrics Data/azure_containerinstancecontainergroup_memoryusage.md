...
The API is used to retrieve Azure Container Instance Group <b>MemoryUsage</b> metric data from Azure API Server (https://management.azure.com/). The metric is the total memory usage in byte.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: MemoryUsage
* <b>NetBrain Display Name</b>: Memory Usage
* <b>Unit</b>: Bytes
