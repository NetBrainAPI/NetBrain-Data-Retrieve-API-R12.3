...
The API is used to retrieve Azure Container Instance Group <b>NetworkBytesReceivedPerSecond</b> metric data from Azure API Server (https://management.azure.com/). The metric is the network bytes received per second.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: NetworkBytesReceivedPerSecond
* <b>NetBrain Display Name</b>: Network Bytes Received Per Second
* <b>Unit</b>: Bytes
