...
The API is used to retrieve Azure App InstanceCount metric data from Azure API Server (https://management.azure.com/). The metric is the number of instances on which this app is running.
