...
The API is used to retrieve Azure App <b>Http3xx</b> metric data from Azure API Server (https://management.azure.com/). The metric is the count of requests resulting in an HTTP status code >= 300 but < 400.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: Http3xx
* <b>NetBrain Display Name</b>: Http3xx
* <b>Unit</b>: Count
