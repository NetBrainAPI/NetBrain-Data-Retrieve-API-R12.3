...
The API is used to retrieve Azure App HttpResponseTime metric data from Azure API Server (https://management.azure.com/). The metric is the time taken for the app to serve requests, in seconds.
