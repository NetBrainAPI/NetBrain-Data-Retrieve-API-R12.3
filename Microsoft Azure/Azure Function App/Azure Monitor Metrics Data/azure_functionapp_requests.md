...
The API is used to retrieve Azure App <b>Requests</b> metric data from Azure API Server (https://management.azure.com/). The metric is the total number of requests regardless of their resulting HTTP status code.
