...
The API is used to retrieve Azure App WorkflowActionsFailureRate metric data from Azure API Server (https://management.azure.com/). The metric is workflow actions failure rate.
