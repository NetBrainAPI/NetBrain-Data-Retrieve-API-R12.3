...
The API is used to retrieve Azure App HealthCheckStatus metric data from Azure API Server (https://management.azure.com/). The metric is health check status.
