...
The API is used to retrieve Azure App TotalAppDomains metric data from Azure API Server (https://management.azure.com/). The metric is the current number of AppDomains loaded in this application.
