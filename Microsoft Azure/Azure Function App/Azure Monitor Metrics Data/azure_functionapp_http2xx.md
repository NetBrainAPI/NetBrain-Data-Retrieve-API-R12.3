...
The API is used to retrieve Azure App Http2xx metric data from Azure API Server (https://management.azure.com/). The metric is the count of requests resulting in an HTTP status code >= 200 but < 300.
