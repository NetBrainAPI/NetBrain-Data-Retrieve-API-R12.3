...
The API is used to retrieve Azure App <b>Threads</b> metric data from Azure API Server (https://management.azure.com/). The metric is the number of threads currently active in the app process.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: Threads
* <b>NetBrain Display Name</b>: Threads
* <b>Unit</b>: Count
