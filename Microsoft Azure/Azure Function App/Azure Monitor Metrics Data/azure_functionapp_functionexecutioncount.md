...
The API is used to retrieve Azure App FunctionExecutionCount metric data from Azure API Server (https://management.azure.com/). The metric is function execution count.
