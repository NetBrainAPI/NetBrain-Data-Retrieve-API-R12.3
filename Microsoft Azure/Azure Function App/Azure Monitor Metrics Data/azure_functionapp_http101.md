...
The API is used to retrieve Azure App <b>Http101</b> metric data from Azure API Server (https://management.azure.com/). The metric is the count of requests resulting in an HTTP status code 101.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: Http101
* <b>NetBrain Display Name</b>: Http101
* <b>Unit</b>: Count
