...
The API is used to retrieve Azure App RequestsInApplicationQueue metric data from Azure API Server (https://management.azure.com/). The metric is the number of requests in the application request queue.
