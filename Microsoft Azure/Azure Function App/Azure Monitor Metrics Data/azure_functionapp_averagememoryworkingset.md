...
The API is used to retrieve Azure APP <b>AverageMemoryWorkingSet</b> metric data from Azure API Server (https://management.azure.com/). The metric is the average amount of memory used by the app, in megabytes (MiB).

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: AverageMemoryWorkingSet
* <b>NetBrain Display Name</b>: Average Memory Working Set
* <b>Unit</b>: Bytes
