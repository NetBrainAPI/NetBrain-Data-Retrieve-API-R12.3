...
The API is used to retrieve Azure App WorkflowTriggersFailureRate metric data from Azure API Server (https://management.azure.com/). The metric is workflow triggers failure rate.
...
* <b>NetBrain Display Name</b>: Workflow Triggered Failure Rate
* <b>Unit</b>: Percent
