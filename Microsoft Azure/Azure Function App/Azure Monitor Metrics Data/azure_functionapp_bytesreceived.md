...
The API is used to retrieve Azure App <b>BytesReceived</b> metric data from Azure API Server (https://management.azure.com/). The metric is the amount of incoming bandwidth consumed by the app, in MiB.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: BytesReceived
* <b>NetBrain Display Name</b>: Bytes Received
* <b>Unit</b>: Bytes
