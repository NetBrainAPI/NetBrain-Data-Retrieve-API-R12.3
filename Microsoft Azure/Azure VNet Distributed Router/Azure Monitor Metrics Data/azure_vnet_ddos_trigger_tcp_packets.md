...
The API is used to retrieve Azure Virtual Network <b>DDoSTriggerTCPPackets</b> metric data from Azure API Server (https://management.azure.com/). The metric is about inbound TCP packets to trigger DDoS mitigation.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: DDoSTriggerTCPPackets
* <b>NetBrain Display Name</b>: DDoS Trigger TCP Packets
