...
The API is used to retrieve Azure Virtual Network <b>UDPPacketsDroppedDDoS</b> metric data from Azure API Server (https://management.azure.com/). The metric is about inbound UDP packets dropped DDoS.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: UDPPacketsDroppedDDoS 
* <b>NetBrain Display Name</b>: UDP Packets Dropped DDoS
