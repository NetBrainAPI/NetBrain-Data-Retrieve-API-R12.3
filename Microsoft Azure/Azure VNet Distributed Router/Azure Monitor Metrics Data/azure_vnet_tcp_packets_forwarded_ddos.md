...
The API is used to retrieve Azure Virtual Network <b>TCPPacketsForwardedDDoS</b> metric data from Azure API Server (https://management.azure.com/). The metric is about inbound TCP packets forwarded DDoS.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: TCPPacketsForwardedDDoS 
* <b>NetBrain Display Name</b>: TCP Packets Forwarded DDoS
