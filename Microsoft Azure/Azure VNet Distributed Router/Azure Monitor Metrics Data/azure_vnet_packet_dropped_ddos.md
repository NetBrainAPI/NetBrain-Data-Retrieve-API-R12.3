...
The API is used to retrieve Azure Virtual Network <b>PacketsDroppedDDoS</b> metric data from Azure API Server (https://management.azure.com/). The metric is about inbound packets dropped DDoS.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: PacketsDroppedDDoS 
* <b>NetBrain Display Name</b>: Packets Dropped DDoS
