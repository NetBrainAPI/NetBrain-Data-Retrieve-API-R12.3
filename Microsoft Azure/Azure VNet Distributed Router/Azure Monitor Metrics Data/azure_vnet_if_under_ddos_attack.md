...
The API is used to retrieve Azure Virtual Network <b>IfUnderDDoSAttack</b> metric data from Azure API Server (https://management.azure.com/). The metric is about under DDoS attack or not.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: IfUnderDDoSAttack
* <b>NetBrain Display Name</b>: If Under DDoS Attack
* <b>Unit</b>: Count
