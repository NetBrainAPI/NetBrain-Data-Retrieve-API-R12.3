...
For a complete list of available API resources for Azure Virtual Network Peerings, please refer to Microsoft document: [Virtual Network Peerings - REST API (Azure Virtual Networks) | Microsoft Learn](https://learn.microsoft.com/en-us/rest/api/virtualnetwork/virtual-network-peerings?view=rest-virtualnetwork-2025-03-01&viewFallbackFrom=rest-virtualnetwork-2024-03-01)


For the original Azure API detailed information, please refer to Microsoft document: [Virtual Network Peerings - List - REST API (Azure Virtual Networks) | Microsoft Learn](https://learn.microsoft.com/en-us/rest/api/virtualnetwork/virtual-network-peerings/list?view=rest-virtualnetwork-2025-03-01&viewFallbackFrom=rest-virtualnetwork-2024-03-01&tabs=HTTP)