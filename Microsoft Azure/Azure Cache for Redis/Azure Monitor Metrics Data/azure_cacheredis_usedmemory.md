...
The API is used to retrieve Azure Cache for Redis <b>usedmemory</b> metric data from Azure API Server (https://management.azure.com/). The metric is the amount of cache memory used for key/value pairs in the cache in MB.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: usedmemory
* <b>NetBrain Display Name</b>: Used Memory
* <b>Unit</b>: Bytes
