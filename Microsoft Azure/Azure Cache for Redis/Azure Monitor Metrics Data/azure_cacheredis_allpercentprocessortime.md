...
The API is used to retrieve Azure Cache for Redis <b>allpercentprocessortime</b> metric data from Azure API Server (https://management.azure.com/). The metric is the CPU utilization of the Azure Redis Cache server as a percentage.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: allpercentprocessortime
* <b>NetBrain Display Name</b>: CPU (Instance Based)
* <b>Unit</b>: Percent
