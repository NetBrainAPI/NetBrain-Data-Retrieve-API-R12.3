...
The API is used to retrieve Azure Cache for Redis <b>percentProcessorTime</b> metric data from Azure API Server (https://management.azure.com/). The metric is the CPU utilization of the Azure Redis Cache server as a percentage.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: percentProcessorTime
* <b>NetBrain Display Name</b>: CPU
* <b>Unit</b>: Percent
