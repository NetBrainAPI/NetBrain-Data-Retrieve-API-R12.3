...
The API is used to retrieve Azure Cache for Redis <b>allconnectedclients</b> metric data from Azure API Server (https://management.azure.com/). The metric is the number of client connections to the cache.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: allconnectedclients
* <b>NetBrain Display Name</b>: Connected Clients (Instance Based)
* <b>Unit</b>: Count
