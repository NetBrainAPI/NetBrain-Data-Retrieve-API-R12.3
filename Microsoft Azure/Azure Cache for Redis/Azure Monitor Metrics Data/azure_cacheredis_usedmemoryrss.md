...
The API is used to retrieve Azure Cache for Redis <b>usedmemoryRss</b> metric data from Azure API Server (https://management.azure.com/). The metric is the amount of cache memory used in MB, including fragmentation and metadata.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: usedmemoryRss
* <b>NetBrain Display Name</b>: Used Memory RSS
* <b>Unit</b>: Bytes
