...
The API is used to retrieve Azure Cache for Redis <b>evictedkeys</b> metric data from Azure API Server (https://management.azure.com/). The metric is the number of items evicted from the cache.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: evictedkeys
* <b>NetBrain Display Name</b>: Evicted Keys
* <b>Unit</b>: Count
