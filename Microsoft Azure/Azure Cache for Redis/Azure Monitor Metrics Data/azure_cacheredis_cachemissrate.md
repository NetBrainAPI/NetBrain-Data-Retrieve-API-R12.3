...
The API is used to retrieve Azure Cache for Redis <b>cachemissrate</b> metric data from Azure API Server (https://management.azure.com/). The metric is the % of get requests that miss.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: cachemissrate
* <b>NetBrain Display Name</b>: Cache Miss Rate
* <b>Unit</b>: Percent
