...
The API is used to retrieve Azure Cache for Redis <b>allserverLoad</b> metric data from Azure API Server (https://management.azure.com/). The metric is the percentage of cycles in which the Redis server is busy processing and not waiting idle for messages.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: allserverLoad
* <b>NetBrain Display Name</b>: Server Load (Instance Based)
* <b>Unit</b>: Percent
