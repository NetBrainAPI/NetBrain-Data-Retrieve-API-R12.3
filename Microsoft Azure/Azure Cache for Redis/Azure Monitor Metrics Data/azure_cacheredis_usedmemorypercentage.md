...
The API is used to retrieve Azure Cache for Redis <b>usedmemorypercentage</b> metric data from Azure API Server (https://management.azure.com/). The metric is the percentage of cache memory used for key/value pairs.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: usedmemorypercentage
* <b>NetBrain Display Name</b>: Used Memory Percentage
* <b>Unit</b>: Percent
