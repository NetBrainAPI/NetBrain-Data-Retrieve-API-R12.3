...
The API is used to retrieve Azure Cache for Redis <b>totalcommandsprocessed</b> metric data from Azure API Server (https://management.azure.com/). The metric is the total number of commands processed by the cache server.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: totalcommandsprocessed
* <b>NetBrain Display Name</b>: Total Operations
* <b>Unit</b>: Count
