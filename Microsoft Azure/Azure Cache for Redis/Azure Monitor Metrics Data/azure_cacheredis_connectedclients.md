...
The API is used to retrieve Azure Cache for Redis <b>connectedclients</b> metric data from Azure API Server (https://management.azure.com/). The metric is the number of client connections to the cache.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: connectedclients
* <b>NetBrain Display Name</b>: Connected Clients
* <b>Unit</b>: Count
