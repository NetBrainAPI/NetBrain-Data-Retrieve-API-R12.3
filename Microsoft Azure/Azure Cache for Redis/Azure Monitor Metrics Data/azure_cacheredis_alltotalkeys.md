...
The API is used to retrieve Azure Cache for Redis <b>alltotalkeys</b> metric data from Azure API Server (https://management.azure.com/). The metric is the total number of items in the cache.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: alltotalkeys
* <b>NetBrain Display Name</b>: Total Keys (Instance Based)
* <b>Unit</b>: Count
