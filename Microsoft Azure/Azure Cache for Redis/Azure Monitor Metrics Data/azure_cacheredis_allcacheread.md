...
The API is used to retrieve Azure Cache for Redis <b>allcacheRead</b> metric data from Azure API Server (https://management.azure.com/). The metric is the amount of data read from the cache in bytes per second.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: allcacheRead
* <b>NetBrain Display Name</b>: Cache Read (Instance Based)
