...
The API is used to retrieve Azure Cache for Redis <b>totalkeys</b> metric data from Azure API Server (https://management.azure.com/). The metric is the total number of items in the cache.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: totalkeys
* <b>NetBrain Display Name</b>: Total Keys
* <b>Unit</b>: Count
