...
The API is used to retrieve Azure Cache for Redis <b>allConnectionsClosedPerSecond</b> metric data from Azure API Server (https://management.azure.com/). The metric is the number of instantaneous connections closed per second on the cache via port 6379 or 6380 (SSL).

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: allConnectionsClosedPerSecond
* <b>NetBrain Display Name</b>: Connections Closed Per Second (Instance Based)
