...
The API is used to retrieve Azure Cache for Redis <b>allsetcommands</b> metric data from Azure API Server (https://management.azure.com/). The metric is the number of set operations to the cache.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: allsetcommands
* <b>NetBrain Display Name</b>: Sets (Instance Based)
* <b>Unit</b>: Count
