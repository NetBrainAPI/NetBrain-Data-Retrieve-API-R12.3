...
The API is used to retrieve Azure Cache for Redis <b>allusedmemory</b> metric data from Azure API Server (https://management.azure.com/). The metric is the amount of cache memory used for key/value pairs in the cache in MB.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: allusedmemory
* <b>NetBrain Display Name</b>: Used Memory (Instance Based)
* <b>Unit</b>: Bytes
