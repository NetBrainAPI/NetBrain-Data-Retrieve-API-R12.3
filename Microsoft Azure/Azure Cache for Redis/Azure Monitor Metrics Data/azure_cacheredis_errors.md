...
The API is used to retrieve Azure Cache for Redis <b>errors</b> metric data from Azure API Server (https://management.azure.com/). The metric is the number errors that occured on the cache.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: errors
* <b>NetBrain Display Name</b>: Errors
* <b>Unit</b>: Count
