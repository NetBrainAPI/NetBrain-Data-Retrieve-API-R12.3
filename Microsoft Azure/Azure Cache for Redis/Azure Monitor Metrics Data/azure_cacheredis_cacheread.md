...
The API is used to retrieve Azure Cache for Redis <b>cacheRead</b> metric data from Azure API Server (https://management.azure.com/). The metric is the amount of data read from the cache in bytes per second.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: cacheRead
* <b>NetBrain Display Name</b>: Cache Read
