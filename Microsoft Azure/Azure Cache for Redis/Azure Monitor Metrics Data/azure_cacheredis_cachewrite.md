...
The API is used to retrieve Azure Cache for Redis <b>cacheWrite</b> metric data from Azure API Server (https://management.azure.com/). The metric is the amount of data written to the cache in bytes per second.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: cacheWrite
* <b>NetBrain Display Name</b>: Cache Write
