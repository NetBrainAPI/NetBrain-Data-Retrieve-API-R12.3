...
The API is used to retrieve Azure Cache for Redis <b>allcachehits</b> metric data from Azure API Server (https://management.azure.com/). The metric is the number of successful key lookups.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: allcachehits
* <b>NetBrain Display Name</b>: Cache Hits (Instance Based)
* <b>Unit</b>: Count
