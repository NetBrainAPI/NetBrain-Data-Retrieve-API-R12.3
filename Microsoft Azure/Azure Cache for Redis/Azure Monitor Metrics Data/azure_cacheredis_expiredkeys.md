...
The API is used to retrieve Azure Cache for Redis <b>expiredkeys</b> metric data from Azure API Server (https://management.azure.com/). The metric is the number of items expired from the cache.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: expiredkeys
* <b>NetBrain Display Name</b>: Expired Keys
* <b>Unit</b>: Count
