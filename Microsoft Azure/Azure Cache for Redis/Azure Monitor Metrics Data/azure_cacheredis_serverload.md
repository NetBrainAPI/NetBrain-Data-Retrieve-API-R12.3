...
The API is used to retrieve Azure Cache for Redis <b>serverLoad</b> metric data from Azure API Server (https://management.azure.com/). The metric is the percentage of cycles in which the Redis server is busy processing and not waiting idle for messages.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: serverLoad
* <b>NetBrain Display Name</b>: Server Load
* <b>Unit</b>: Percent
