...
The API is used to retrieve Azure Cache for Redis <b>cacheLatency</b> metric data from Azure API Server (https://management.azure.com/). The metric is the latency to the cache in microseconds.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: cacheLatency
* <b>NetBrain Display Name</b>: Cache Latency Microseconds (Preview)
* <b>Unit</b>: Count
