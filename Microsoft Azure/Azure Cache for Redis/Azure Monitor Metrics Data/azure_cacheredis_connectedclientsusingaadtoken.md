...
The API is used to retrieve Azure Cache for Redis <b>ConnectedClientsUsingAADToken</b> metric data from Azure API Server (https://management.azure.com/). The metric is the number of client connections to the cache using Microsoft Entra Token.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: ConnectedClientsUsingAADToken
* <b>NetBrain Display Name</b>: Connected Clients using Microsoft Entra Token (Instance Based)
* <b>Unit</b>: Count
