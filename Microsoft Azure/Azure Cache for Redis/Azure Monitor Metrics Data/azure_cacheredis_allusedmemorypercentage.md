...
The API is used to retrieve Azure Cache for Redis <b>allusedmemorypercentage</b> metric data from Azure API Server (https://management.azure.com/). The metric is the percentage of cache memory used for key/value pairs.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: allusedmemorypercentage
* <b>NetBrain Display Name</b>: Used Memory Percentage (Instance Based)
* <b>Unit</b>: Percent
