...
* <b>Interval</b>: Valid values: PT1M. Default value is <b>PT1M</b>.
  ...
  * <b>PT1H</b>: Reporting interval for Metrics will have a timegrain of 1 hour.* <b>Auto Adjust Timegrain</b>: When set to true, if the timespan passed in is not supported by this metric, the API will return the result using the closest supported timespan. When set to false, an error is returned for invalid timespan parameters. Defaults to <b>false</b>.
