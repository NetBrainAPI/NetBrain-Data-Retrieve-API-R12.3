...
The API is used to retrieve Azure App <b>Handles</b> metric data from Azure API Server (https://management.azure.com/). The metric is the total number of handles currently open by the app process. The Unit is Count. The Aggregation Type is Average. Time Grain (Intervals at which the metric is sampled) is PT1M(Every 1 minute). The Azure monitor metrics original name: Handles.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: Handles
* <b>NetBrain Display Name</b>: Handles
* <b>Unit</b>: Count
