...
The API is used to retrieve Azure App <b>HealthCheckStatus</b> metric data from Azure API Server (https://management.azure.com/). The metric is health check status.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: HealthCheckStatus
* <b>NetBrain Display Name</b>: Health Check Status
* <b>Unit</b>: Count
...
* <b>Interval</b>: Valid values: PT5M, PT1H and P1D. Default value is <b>PT5M</b>.
