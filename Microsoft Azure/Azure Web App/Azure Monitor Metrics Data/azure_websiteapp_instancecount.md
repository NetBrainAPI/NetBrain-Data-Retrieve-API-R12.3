...
The API is used to retrieve Azure App <b>InstanceCount</b> metric data from Azure API Server (https://management.azure.com/). The metric is the number of instances on which this app is running.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: InstanceCount
* <b>NetBrain Display Name</b>: Instance Count
* <b>Unit</b>: Count
