...
The API is used to retrieve Azure App <b>MemoryWorkingSet</b> metric data from Azure API Server (https://management.azure.com/). The metric is the current amount of memory used by the app, in MiB.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: MemoryWorkingSet
* <b>NetBrain Display Name</b>: Memory Working Set
* <b>Unit</b>: Bytes
