...
The API is used to retrieve Azure App <b>IoWriteBytesPerSecond</b> metric data from Azure API Server (https://management.azure.com/). The metric is the rate at which the app process is writing bytes to I/O operations.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: IoWriteBytesPerSecond
* <b>NetBrain Display Name</b>: IO Write Bytes Per Second
