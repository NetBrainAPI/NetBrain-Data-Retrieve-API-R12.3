...
The API is used to retrieve Azure App <b>Http5xx</b> metric data from Azure API Server (https://management.azure.com/). The metric is the count of requests resulting in an HTTP status code >= 500 but < 600.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: Http5xx
* <b>NetBrain Display Name</b>: Http5xx
* <b>Unit</b>: Count
