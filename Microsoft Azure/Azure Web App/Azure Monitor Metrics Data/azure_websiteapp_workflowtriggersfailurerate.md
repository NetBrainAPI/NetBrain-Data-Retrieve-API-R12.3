...
The API is used to retrieve Azure App <b>WorkflowTriggersFailureRate</b> metric data from Azure API Server (https://management.azure.com/). The metric is workflow triggers failure rate.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: WorkflowTriggersFailureRate
* <b>NetBrain Display Name</b>: Workflow Triggers Failure Rate
* <b>Unit</b>: Percent
