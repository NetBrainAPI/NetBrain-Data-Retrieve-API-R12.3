...
The API is used to retrieve Azure App <b>CurrentAssemblies</b> metric data from Azure API Server (https://management.azure.com/). The metric is the current number of Assemblies loaded across all AppDomains in this application.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: CurrentAssemblies
* <b>NetBrain Display Name</b>: Current Assemblies
* <b>Unit</b>: Count
