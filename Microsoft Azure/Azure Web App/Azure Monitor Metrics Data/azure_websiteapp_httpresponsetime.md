...
The API is used to retrieve Azure App <b>HttpResponseTime</b> metric data from Azure API Server (https://management.azure.com/). The metric is the time taken for the app to serve requests, in seconds.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: HttpResponseTime
* <b>NetBrain Display Name</b>: Http Response Time
* <b>Unit</b>: Seconds
