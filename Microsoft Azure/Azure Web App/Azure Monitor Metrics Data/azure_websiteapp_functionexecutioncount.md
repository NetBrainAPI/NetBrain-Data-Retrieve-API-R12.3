...
The API is used to retrieve Azure App <b>FunctionExecutionCount</b> metric data from Azure API Server (https://management.azure.com/). The metric is function execution count.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: FunctionExecutionCount
* <b>NetBrain Display Name</b>: Function Execution Count
* <b>Unit</b>: Count
