...
The API is used to retrieve Azure App <b>WorkflowActionsFailureRate</b> metric data from Azure API Server (https://management.azure.com/). The metric is workflow actions failure rate.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: WorkflowActionsFailureRate
* <b>NetBrain Display Name</b>: Workflow Actions Failure Rate
* <b>Unit</b>: Percent
