...
The API is used to retrieve Azure APP <b>AppConnections</b> metric data from Azure API Server (https://management.azure.com/). The metric is the number of bound sockets existing in the sandbox (w3wp.exe and its child processes).

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: AppConnections
* <b>NetBrain Display Name</b>: App Connections
* <b>Unit</b>: Count
