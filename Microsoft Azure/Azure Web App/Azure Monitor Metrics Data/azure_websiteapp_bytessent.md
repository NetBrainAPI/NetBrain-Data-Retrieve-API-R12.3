...
The API is used to retrieve Azure App <b>BytesSent</b> metric data from Azure API Server (https://management.azure.com/). The metric is the amount of outgoing bandwidth consumed by the app, in MiB.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: BytesSent
* <b>NetBrain Display Name</b>: Bytes Sent
* <b>Unit</b>: Bytes
