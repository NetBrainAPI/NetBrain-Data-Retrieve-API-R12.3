...
The API is used to retrieve Azure Analysis Service <b>MemoryUsage</b> metric data from Azure API Server (https://management.azure.com/). The metric is memory usage of the server process as used in calculating cleaner memory price.
