...
The API is used to retrieve Azure Analysis Service <b>TotalConnectionRequests</b> metric data from Azure API Server (https://management.azure.com/). The metric is total connection requests.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: TotalConnectionRequests
* <b>NetBrain Display Name</b>: Total Connection Requests
* <b>Unit</b>: Count
