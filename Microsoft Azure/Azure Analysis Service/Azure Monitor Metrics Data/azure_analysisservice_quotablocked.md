...
The API is used to retrieve Azure Analysis Service <b>QuotaBlocked</b> metric data from Azure API Server (https://management.azure.com/). The metric is current number of quota requests that are blocked until other memory quotas are freed.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: QuotaBlocked
* <b>NetBrain Display Name</b>: Quota Blocked
* <b>Unit</b>: Count
