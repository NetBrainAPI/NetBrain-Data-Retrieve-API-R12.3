...
The API is used to retrieve Azure Analysis Service <b>SuccessfullConnectionsPerSec</b> metric data from Azure API Server (https://management.azure.com/). The metric is rate of successful connection completions.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: SuccessfullConnectionsPerSec
* <b>NetBrain Display Name</b>: Successful Connections Per Sec
...
* <b>Metrics Details</b>: https://learn.microsoft.com/en-us/azure/azure-monitor/reference/supported-metrics/microsoft-analysisservices-servers-metrics
