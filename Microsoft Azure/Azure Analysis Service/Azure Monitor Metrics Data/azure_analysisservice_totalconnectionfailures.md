...
The API is used to retrieve Azure Analysis Service <b>TotalConnectionFailures</b> metric data from Azure API Server (https://management.azure.com/). The metric is total failed connection attempts.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: TotalConnectionFailures
* <b>NetBrain Display Name</b>: Total Connection Failures
* <b>Unit</b>: Count
