...
The API is used to retrieve Azure Analysis Service <b>Quota</b> metric data from Azure API Server (https://management.azure.com/). The metric is current memory quota, in bytes.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: Quota
* <b>NetBrain Display Name</b>: Quota
* <b>Unit</b>: Bytes
