...
The API is used to retrieve Azure Elastic SAN Instance <b>Egress</b> metric data from Azure API Server (https://management.azure.com/). The metric is the amount of egress data.
