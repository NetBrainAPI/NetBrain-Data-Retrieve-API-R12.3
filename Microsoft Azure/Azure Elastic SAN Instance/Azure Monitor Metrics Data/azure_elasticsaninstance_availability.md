...
The API is used to retrieve Azure Elastic SAN Instance <b>Availability</b> metric data from Azure API Server (https://management.azure.com/). The metric is the percentage of availability for the storage service or the specified API operation.
