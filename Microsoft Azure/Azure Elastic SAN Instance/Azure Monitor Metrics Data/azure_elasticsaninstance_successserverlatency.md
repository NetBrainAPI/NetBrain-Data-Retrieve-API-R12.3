...
The API is used to retrieve Azure Elastic SAN Instance <b>SuccessServerLatency</b> metric data from Azure API Server (https://management.azure.com/). The metric is the average time used to process a successful request by Azure Storage.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: SuccessServerLatency
* <b>NetBrain Display Name</b>: Success Server Latency
