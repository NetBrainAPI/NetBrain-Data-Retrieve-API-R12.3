...
The API is used to retrieve Azure Elastic SAN Instance <b>Transactions</b> metric data from Azure API Server (https://management.azure.com/). The metric is the number of requests made to a storage service or the specified API operation. The Unit is Count. The Aggregation Type is Total (Sum). Time Grain (Intervals at which the metric is sampled) is PT1M(Every 1 minute). The Azure monitor metrics original name: Transactions.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: Transactions
* <b>NetBrain Display Name</b>: Transactions
* <b>Unit</b>: Count
...
* <b>Metrics Details</b>: https://learn.microsoft.com/en-us/azure/azure-monitor/reference/supported-metrics/microsoft-elasticsan-elasticsans-metrics
