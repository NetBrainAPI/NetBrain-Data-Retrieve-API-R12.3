...
The API is used to retrieve Azure Front Door <b>RequestSize</b> metric data from Azure API Server (https://management.azure.com/). The metric is the number of bytes sent as requests from clients to the HTTP/S proxy.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.


# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: RequestSize
* <b>NetBrain Display Name</b>: Request Size
* <b>Unit</b>: Bytes
