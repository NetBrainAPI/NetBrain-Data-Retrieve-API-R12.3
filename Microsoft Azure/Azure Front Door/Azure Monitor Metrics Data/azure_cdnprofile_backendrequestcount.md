...
The API is used to retrieve Azure Front Door <b>BackendRequestCount</b> metric data from Azure API Server (https://management.azure.com/). The metric is the number of requests sent from the HTTP/S proxy to backends.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.


# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: BackendRequestCount
* <b>NetBrain Display Name</b>: Backend Request Count
* <b>Unit</b>: Count
