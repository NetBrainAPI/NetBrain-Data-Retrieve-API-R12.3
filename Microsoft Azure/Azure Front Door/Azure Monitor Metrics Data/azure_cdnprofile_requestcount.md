...
The API is used to retrieve Azure Front Door <b>RequestCount</b> metric data from Azure API Server (https://management.azure.com/). The metric is the number of client requests served by the HTTP/S proxy.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.


# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: RequestCount
* <b>NetBrain Display Name</b>: Request Count
* <b>Unit</b>: Count
