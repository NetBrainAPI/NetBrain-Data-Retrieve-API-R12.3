...
The API is used to retrieve Azure Front Door <b>BackendHealthPercentage metric</b> data from Azure API Server (https://management.azure.com/). The metric is the percentage of successful health probes from the HTTP/S proxy to backends.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.


# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: BackendHealthPercentage
* <b>NetBrain Display Name</b>: Backend Health Percentage
* <b>Unit</b>: Percent
