...
The API is used to retrieve Azure Front Door <b>ResponseSize</b> metric data from Azure API Server (https://management.azure.com/). The metric is the number of bytes sent as responses from HTTP/S proxy to clients.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.


# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: ResponseSize
* <b>NetBrain Display Name</b>: Response Size
* <b>Unit</b>: Bytes
