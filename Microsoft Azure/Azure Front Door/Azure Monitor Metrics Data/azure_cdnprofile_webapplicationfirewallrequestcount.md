...
The API is used to retrieve Azure Front Door <b>WebApplicationFirewallRequestCount</b> metric data from Azure API Server (https://management.azure.com/). The metric is the number of client requests processed by the Web Application Firewall.
