...
The API is used to retrieve Azure Public DNS Zones <b>RecordSetCapacityUtilization</b> metric data from Azure API Server (https://management.azure.com/). The metric is the percent of Record Set capacity utilized by a DNS zone.
