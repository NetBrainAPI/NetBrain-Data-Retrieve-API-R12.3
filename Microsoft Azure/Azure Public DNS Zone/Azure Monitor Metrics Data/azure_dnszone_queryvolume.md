...
The API is used to retrieve Azure Public DNS Zones <b>QueryVolume</b> metric data from Azure API Server (https://management.azure.com/). The metric is the number of queries served for a DNS zone.
