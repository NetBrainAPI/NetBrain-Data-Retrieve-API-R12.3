...
The API is used to retrieve Azure Public DNS Zones <b>RecordSetCount</b> metric data from Azure API Server (https://management.azure.com/). The metric is the number of Record Sets in a DNS zone.
