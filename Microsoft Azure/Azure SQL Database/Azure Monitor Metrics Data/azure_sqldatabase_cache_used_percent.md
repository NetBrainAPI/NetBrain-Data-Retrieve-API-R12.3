...
The API is used to retrieve Azure SQL Databases <b>cache_used_percent</b> metric data from Azure API Server (https://management.azure.com/). The metric is cache used percentage.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: cache_used_percent
* <b>NetBrain Display Name</b>: Cache Used Percent
* <b>Unit</b>: Percent
