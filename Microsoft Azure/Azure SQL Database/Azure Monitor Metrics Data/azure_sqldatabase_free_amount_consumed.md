...
The API is used to retrieve Azure SQL Databases <b>free_amount_consumed</b> metric data from Azure API Server (https://management.azure.com/). The metric is free amount of vCore seconds consumed this month.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: free_amount_consumed
* <b>NetBrain Display Name</b>: Free Amount Consumed
* <b>Unit</b>: Count
...
* <b>Interval</b>: Valid values: PT15M, PT30M, PT1H, PT6H, PT12H and P1D. Default value is <b>PT15M</b>.
