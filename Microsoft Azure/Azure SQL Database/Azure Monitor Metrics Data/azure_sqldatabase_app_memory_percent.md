...
The API is used to retrieve Azure SQL Databases <b>app_memory_percent</b> metric data from Azure API Server (https://management.azure.com/). The metric is CPU memory consumption toward the app package maximum memory limit, expressed as a percentage for serverless databases.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: app_memory_percent
* <b>NetBrain Display Name</b>: App Memory Percentage
* <b>Unit</b>: Percent
