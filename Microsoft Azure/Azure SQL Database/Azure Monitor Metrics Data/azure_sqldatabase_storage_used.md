...
The API is used to retrieve Azure SQL Databases <b>storage_used</b> metric data from Azure API Server (https://management.azure.com/). The metric is the amount of storage space used in the data files of all databases in an elastic pool.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: storage_used
* <b>NetBrain Display Name</b>: Storage Used
* <b>Unit</b>: Bytes
