...
The API is used to retrieve Azure SQL Databases <b>app_cpu_billed</b> metric data from Azure API Server (https://management.azure.com/). The metric is the amount of compute (CPU and memory) billed, expressed in vCore seconds for serverless databases.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: app_cpu_billed
* <b>NetBrain Display Name</b>: App CPU Billed
* <b>Unit</b>: Count
