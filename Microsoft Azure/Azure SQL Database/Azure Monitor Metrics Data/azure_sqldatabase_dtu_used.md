...
The API is used to retrieve Azure SQL Databases <b>dtu_used</b> metric data from Azure API Server (https://management.azure.com/). The metric is the number of DTUs used by a database or an elastic pool.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: dtu_used
* <b>NetBrain Display Name</b>: DTU Used
* <b>Unit</b>: Count
