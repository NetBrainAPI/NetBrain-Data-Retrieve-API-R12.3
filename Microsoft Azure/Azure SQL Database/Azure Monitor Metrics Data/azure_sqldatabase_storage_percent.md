...
The API is used to retrieve Azure SQL Databases <b>storage_percent</b> metric data from Azure API Server (https://management.azure.com/). The metric is the amount of storage space used in the data files of a database toward the data size limit of a database and the amount of storage space used in the data files of all databases in an elastic pool, expressed as a percentage toward the data size limit of an elastic pool.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: storage_percent
* <b>NetBrain Display Name</b>: Storage Percent
* <b>Unit</b>: Percent
