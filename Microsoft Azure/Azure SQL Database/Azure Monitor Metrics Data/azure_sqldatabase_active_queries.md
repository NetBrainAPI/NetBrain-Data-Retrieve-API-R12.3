...
The API is used to retrieve Azure SQL Databases <b>active_queries</b> metric data from Azure API Server (https://management.azure.com/). The metric is active queries across all workload groups. 

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: active_queries
* <b>NetBrain Display Name</b>: Active Queries
* <b>Unit</b>: Count
