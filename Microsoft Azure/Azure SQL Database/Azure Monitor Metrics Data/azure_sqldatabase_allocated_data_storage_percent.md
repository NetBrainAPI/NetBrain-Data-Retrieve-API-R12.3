...
The API is used to retrieve Azure SQL Databases <b>allocated_data_storage_percent</b> metric data from Azure API Server (https://management.azure.com/). The metric is the amount of storage space occupied by the data files of all databases in an elastic pool toward the data size limit of the pool, expressed as a percentage.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: allocated_data_storage_percent
* <b>NetBrain Display Name</b>: Allocated Data Storage Percent
* <b>Unit</b>: Percent
