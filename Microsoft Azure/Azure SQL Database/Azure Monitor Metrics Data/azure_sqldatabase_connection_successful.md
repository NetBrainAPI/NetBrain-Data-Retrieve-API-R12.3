...
The API is used to retrieve Azure SQL Databases <b>connection_successful</b> metric data from Azure API Server (https://management.azure.com/). The metric is the number of successfully established connections to a database.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: connection_successful
* <b>NetBrain Display Name</b>: Connection Successful
* <b>Unit</b>: Count
