...
The API is used to retrieve Azure SQL Databases <b>connection_failed</b> metric data from Azure API Server (https://management.azure.com/). The metric is the number of connection attempts to a database that failed because of internal service errors.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: connection_failed
* <b>NetBrain Display Name</b>: Connection Failed
* <b>Unit</b>: Count
