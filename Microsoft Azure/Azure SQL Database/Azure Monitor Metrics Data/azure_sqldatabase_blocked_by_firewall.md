...
The API is used to retrieve Azure SQL Databases <b>blocked_by_firewall</b> metric data from Azure API Server (https://management.azure.com/). The metric is to block by Firewall.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: blocked_by_firewall
* <b>NetBrain Display Name</b>: Blocked By Firewall
* <b>Unit</b>: Count
