...
The API is used to retrieve Azure SQL Databases <b>cpu_used</b> metric data from Azure API Server (https://management.azure.com/). The metric is CPU consumption toward the user workload limit of a database or an elastic pool, expressed as the number of vCores.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: cpu_used
* <b>NetBrain Display Name</b>: CPU Used
* <b>Unit</b>: Count
