...
The API is used to retrieve Azure SQL Databases <b>sessions_percent</b> metric data from Azure API Server (https://management.azure.com/). The metric is sessions percentage.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: sessions_percent
* <b>NetBrain Display Name</b>: Sessions Percent
* <b>Unit</b>: Percent
