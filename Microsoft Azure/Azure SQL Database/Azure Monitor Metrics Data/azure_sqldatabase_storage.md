...
The API is used to retrieve Azure SQL Databases <b>storage</b> metric data from Azure API Server (https://management.azure.com/). The metric is the amount of storage space used in the data files of a database.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: storage
* <b>NetBrain Display Name</b>: Storage
* <b>Unit</b>: Bytes
