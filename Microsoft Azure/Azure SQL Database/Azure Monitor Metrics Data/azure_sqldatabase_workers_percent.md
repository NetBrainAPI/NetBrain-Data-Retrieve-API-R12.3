...
The API is used to retrieve Azure SQL Databases <b>workers_percent</b> metric data from Azure API Server (https://management.azure.com/). The metric is the consumption of worker threads toward the user workload limit of a database or an elastic pool, expressed as a percentage.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.


# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: workers_percent
* <b>NetBrain Display Name</b>: Workers Percentage
* <b>Unit</b>: Percent
