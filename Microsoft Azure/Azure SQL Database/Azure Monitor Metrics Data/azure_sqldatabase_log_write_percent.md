...
The API is used to retrieve Azure SQL Databases <b>log_write_percent</b> metric data from Azure API Server (https://management.azure.com/). The metric is the transaction log write throughput consumption toward the user workload limit of a database or an elastic pool, expressed as a percentage.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.


# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: log_write_percent
* <b>NetBrain Display Name</b>: Log IO Percentage
* <b>Unit</b>: Percent
