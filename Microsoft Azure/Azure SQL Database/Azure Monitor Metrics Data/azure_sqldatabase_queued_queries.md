...
The API is used to retrieve Azure SQL Databases <b>queued_queries</b> metric data from Azure API Server (https://management.azure.com/). The metric is queued queries across all workload group.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: queued_queries
* <b>NetBrain Display Name</b>: Queued Queries
* <b>Unit</b>: Count
