...
The API is used to retrieve Azure SQL Databases <b>replication_lag_seconds</b> metric data from Azure API Server (https://management.azure.com/). The metric is the number of seconds that the secondary database is behind the primary database.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: replication_lag_seconds
* <b>NetBrain Display Name</b>: Replication Lag Seconds
* <b>Unit</b>: Seconds
