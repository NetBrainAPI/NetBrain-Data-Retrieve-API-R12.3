...
The API is used to retrieve Azure SQL Databases <b>sessions_count</b> metric data from Azure API Server (https://management.azure.com/). The metric is the number of established user sessions for a database or an elastic pool.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: sessions_count
* <b>NetBrain Display Name</b>: Sessions Count
* <b>Unit</b>: Count
