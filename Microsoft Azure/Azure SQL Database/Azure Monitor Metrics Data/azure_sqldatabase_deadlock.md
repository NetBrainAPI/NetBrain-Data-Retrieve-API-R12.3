...
The API is used to retrieve Azure SQL Databases <b>deadlock</b> metric data from Azure API Server (https://management.azure.com/). The metric is the number of deadlocks in a database.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: deadlock
* <b>NetBrain Display Name</b>: Deadlock
* <b>Unit</b>: Count
