...
The API is used to retrieve Azure Managed Instance for Apache Cassandra Cluster <b>diskio_merged_writes</b> metric data from Azure API Server (https://management.azure.com/). The metric is cumulative disk I/O merged writes.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: diskio_merged_writes
* <b>NetBrain Display Name</b>: Disk I/O Merged Writes
* <b>Unit</b>: Count
