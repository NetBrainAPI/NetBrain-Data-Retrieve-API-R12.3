...
The API is used to retrieve Azure Managed Instance for Apache Cassandra Cluster <b>diskio_read_bytes</b> metric data from Azure API Server (https://management.azure.com/). The metric is cumulative disk I/O read bytes.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: diskio_read_bytes
* <b>NetBrain Display Name</b>: Disk I/O Read Bytes
* <b>Unit</b>: Bytes
