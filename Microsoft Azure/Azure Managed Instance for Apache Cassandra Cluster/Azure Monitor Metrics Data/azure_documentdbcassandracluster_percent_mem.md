...
The API is used to retrieve Azure Managed Instance for Apache Cassandra Cluster <b>percent_mem</b> metric data from Azure API Server (https://management.azure.com/). The metric is memory utilization rate.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: percent_mem
* <b>NetBrain Display Name</b>: Memory Utilization
* <b>Unit</b>: Percent
