...
The API is used to retrieve Azure Managed Instance for Apache Cassandra Cluster <b>cpu</b> metric data from Azure API Server (https://management.azure.com/). The metric is CPU usage (active).

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: cpu
* <b>NetBrain Display Name</b>: CPU Usage Active
* <b>Unit</b>: Percent
