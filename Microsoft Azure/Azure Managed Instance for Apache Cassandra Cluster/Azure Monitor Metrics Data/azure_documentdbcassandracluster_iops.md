...
The API is used to retrieve Azure Managed Instance for Apache Cassandra Cluster <b>iops</b> metric data from Azure API Server (https://management.azure.com/). The metric is I/O operations and bytes per second.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: iops
* <b>NetBrain Display Name</b>: IOPS (Including Throughput)
* <b>Unit</b>: Count
