...
The API is used to retrieve Azure Managed Instance for Apache Cassandra Cluster <b>ethtool_rx_packets</b> metric data from Azure API Server (https://management.azure.com/). The metric is cumulative network received packets.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: ethtool_rx_packets
* <b>NetBrain Display Name</b>: Network Received Packets
* <b>Unit</b>: Count
