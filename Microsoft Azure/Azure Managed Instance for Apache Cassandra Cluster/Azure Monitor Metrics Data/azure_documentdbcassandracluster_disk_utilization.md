...
The API is used to retrieve Azure Managed Instance for Apache Cassandra Cluster <b>disk_utilization</b> metric data from Azure API Server (https://management.azure.com/). The metric is disk utilization rate.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: disk_utilization
* <b>NetBrain Display Name</b>: Disk Utilization
* <b>Unit</b>: Percent
