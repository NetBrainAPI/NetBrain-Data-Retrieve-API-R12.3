...
The API is used to retrieve Azure Managed Instance for Apache Cassandra Cluster <b>raid_array_rebuild</b> metric data from Azure API Server (https://management.azure.com/). The metric is percentage of RAID array rebuild.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: raid_array_rebuild
* <b>NetBrain Display Name</b>: RAID Array Rebuild
* <b>Unit</b>: Percent
