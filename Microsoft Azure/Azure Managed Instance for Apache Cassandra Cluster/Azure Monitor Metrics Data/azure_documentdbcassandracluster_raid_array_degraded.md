...
The API is used to retrieve Azure Managed Instance for Apache Cassandra Cluster <b>raid_array_degraded</b> metric data from Azure API Server (https://management.azure.com/). The metric is whether RAID array is degraded.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: raid_array_degraded
* <b>NetBrain Display Name</b>: RAID Array Degraded
* <b>Unit</b>: Count
