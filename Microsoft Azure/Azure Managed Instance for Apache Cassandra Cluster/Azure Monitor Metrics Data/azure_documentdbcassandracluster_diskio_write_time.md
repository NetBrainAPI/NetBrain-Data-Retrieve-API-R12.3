...
The API is used to retrieve Azure Managed Instance for Apache Cassandra Cluster <b>diskio_write_time</b> metric data from Azure API Server (https://management.azure.com/). The metric is cumulative disk I/O write time (milliseconds).

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: diskio_write_time
* <b>NetBrain Display Name</b>: Disk I/O Write Time (Milliseconds)
...
* <b>Metrics Details</b>: https://learn.microsoft.com/en-us/azure/azure-monitor/reference/supported-metrics/microsoft-documentdb-cassandraclusters-metrics
