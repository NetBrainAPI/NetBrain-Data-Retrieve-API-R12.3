...
The API is used to retrieve Azure Azure Data Factory Instance <b>ActivityFailedRuns</b> metric data from Azure API Server (https://management.azure.com/). The metric is failed activity runs metrics.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: ActivityFailedRuns
* <b>NetBrain Display Name</b>: Activity Failed Runs
* <b>Unit</b>: Count
