...
The API is used to retrieve Azure Data Factory Instance <b>ActivitySucceededRuns</b> metric data from Azure API Server (https://management.azure.com/). The metric is succeeded activity runs metrics.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: ActivitySucceededRuns
* <b>NetBrain Display Name</b>: Activity Succeeded Runs
* <b>Unit</b>: Count
