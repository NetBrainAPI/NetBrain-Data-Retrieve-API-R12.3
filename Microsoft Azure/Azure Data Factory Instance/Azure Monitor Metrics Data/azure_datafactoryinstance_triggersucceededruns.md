...
The API is used to retrieve Azure Data Factory Instance <b>TriggerSucceededRuns</b> metric data from Azure API Server (https://management.azure.com/). The metric is succeeded trigger runs metrics.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: TriggerSucceededRuns
* <b>NetBrain Display Name</b>: Trigger Succeeded Runs
* <b>Unit</b>: Count
