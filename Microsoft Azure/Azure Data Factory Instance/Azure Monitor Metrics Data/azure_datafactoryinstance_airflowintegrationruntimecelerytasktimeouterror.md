...
The API is used to retrieve Azure Data Factory Instance <b>AirflowIntegrationRuntimeCeleryTaskTimeoutError</b> metric data from Azure API Server (https://management.azure.com/). The metric is airflow Integration Runtime Celery Task Timeout Error.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: AirflowIntegrationRuntimeCeleryTaskTimeoutError
* <b>NetBrain Display Name</b>: Airflow Integration Runtime Celery Task Timeout Error
* <b>Unit</b>: Count
...
* <b>Metrics Details</b>: https://learn.microsoft.com/en-us/azure/azure-monitor/reference/supported-metrics/microsoft-datafactory-factories-metrics
