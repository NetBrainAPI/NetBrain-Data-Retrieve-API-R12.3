...
The API is used to retrieve Azure Azure Data Factory Instance <b>ActivityCancelledRuns</b> metric data from Azure API Server (https://management.azure.com/). The metric is cancelled activity runs metrics.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: ActivityCancelledRuns
* <b>NetBrain Display Name</b>: Activity Cancelled Runs
* <b>Unit</b>: Count
