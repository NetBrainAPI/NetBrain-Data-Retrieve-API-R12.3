...
The API is used to retrieve Azure Data Factory Instance <b>AirflowIntegrationRuntimeCpuPercentage</b> metric data from Azure API Server (https://management.azure.com/). The metric is airflow Integration Runtime Cpu Percentage.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: AirflowIntegrationRuntimeCpuPercentage
* <b>NetBrain Display Name</b>: Airflow Integration Runtime CPU Percentage
* <b>Unit</b>: Percent
