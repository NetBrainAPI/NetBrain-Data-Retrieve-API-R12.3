...
The API is used to retrieve Azure Data Factory Instance <b>TriggerCancelledRuns</b> metric data from Azure API Server (https://management.azure.com/). The metric is cancelled trigger runs metrics.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: TriggerCancelledRuns
* <b>NetBrain Display Name</b>: Trigger Cancelled Runs
* <b>Unit</b>: Count
