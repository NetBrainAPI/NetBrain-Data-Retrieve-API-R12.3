...
The API is used to retrieve Azure Data Factory Instance <b>AirflowIntegrationRuntimeCpuUsage</b> metric data from Azure API Server (https://management.azure.com/). The metric is airflow Integration Runtime Cpu Usage.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: AirflowIntegrationRuntimeCpuUsage
* <b>NetBrain Display Name</b>: Airflow Integration Runtime CPU Usage
* <b>Unit</b>: Millicores
