...
The API is used to retrieve Azure Data Factory Instance <b>AirflowIntegrationRuntimeDagCallbackExceptions</b> metric data from Azure API Server (https://management.azure.com/). The metric is airflow integration runtime dag callback exceptions.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: AirflowIntegrationRuntimeDagCallbackExceptions
* <b>NetBrain Display Name</b>: Airflow Integration Runtime Dag Callback Exceptions
* <b>Unit</b>: Count
