...
The API is used to retrieve Azure Private DNS Zones <b>VirtualNetworkLinkCount</b> metric data from Azure API Server (https://management.azure.com/). The metric is the number of Virtual Networks linked to a Private DNS zone.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: VirtualNetworkLinkCount
* <b>NetBrain Display Name</b>: Virtual Network Link Count
* <b>Unit</b>: Count
