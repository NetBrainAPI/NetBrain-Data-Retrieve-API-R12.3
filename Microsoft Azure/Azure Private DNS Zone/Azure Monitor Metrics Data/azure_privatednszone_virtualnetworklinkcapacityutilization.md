...
The API is used to retrieve Azure Private DNS Zones <b>VirtualNetworkLinkCapacityUtilization</b> metric data from Azure API Server (https://management.azure.com/). The metric is the percent of Virtual Network Link capacity utilized by a Private DNS zone.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: VirtualNetworkLinkCapacityUtilization
* <b>NetBrain Display Name</b>: Virtual Network Link Capacity Utilization
* <b>Unit</b>: Percent
