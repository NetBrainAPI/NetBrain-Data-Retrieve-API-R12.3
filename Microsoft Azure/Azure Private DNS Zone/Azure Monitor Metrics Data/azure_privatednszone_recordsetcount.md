...
The API is used to retrieve Azure Private DNS Zones <b>RecordSetCount</b> metric data from Azure API Server (https://management.azure.com/). The metric is the number of Record Sets in a Private DNS zone.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: RecordSetCount
* <b>NetBrain Display Name</b>: Record Set Count
* <b>Unit</b>: Count
