...
The API is used to retrieve Azure Private DNS Zones <b>RecordSetCapacityUtilization</b> metric data from Azure API Server (https://management.azure.com/). The metric is the percent of Record Set capacity utilized by a Private DNS zone.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: RecordSetCapacityUtilization
* <b>NetBrain Display Name</b>: Record Set Capacity Utilization
* <b>Unit</b>: Percent
