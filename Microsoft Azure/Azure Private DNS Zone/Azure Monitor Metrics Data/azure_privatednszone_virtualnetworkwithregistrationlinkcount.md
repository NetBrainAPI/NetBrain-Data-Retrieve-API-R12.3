...
The API is used to retrieve Azure Private DNS Zones <b>VirtualNetworkWithRegistrationLinkCount</b> metric data from Azure API Server (https://management.azure.com/). The metric is the number of Virtual Networks linked to a Private DNS zone with auto-registration enabled.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: VirtualNetworkWithRegistrationLinkCount
* <b>NetBrain Display Name</b>: Virtual Network With Registration Link Count
* <b>Unit</b>: Count
