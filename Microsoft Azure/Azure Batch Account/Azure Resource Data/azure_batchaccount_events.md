...
For a complete list of available API resources for Azure Batch Account, please refer to Microsoft document: [Events - REST API (Azure Resource Health) | Microsoft Learn](https://learn.microsoft.com/en-us/rest/api/resourcehealth/events?view=rest-resourcehealth-2025-05-01)
