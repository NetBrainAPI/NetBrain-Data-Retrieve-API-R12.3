...
The API is used to retrieve Azure MSEE <b>QosDropBitsInPerSecond</b> metric data from Azure API Server (https://management.azure.com/). The metric is about ingress bits of Qos data dropped per second.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.


# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: QosDropBitsInPerSecond 
