...
The API is used to retrieve Azure MSEE <b>BitsOutPerSecond</b> metric data from Azure API Server (https://management.azure.com/). The metric is about bits egressing Azure per second.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.


# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: BitsOutPerSecond 
* <b>NetBrain Display Name</b>: Bits Out Per Second
