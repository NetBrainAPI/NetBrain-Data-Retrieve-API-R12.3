...
The API is used to retrieve Azure Container App Instance <b>WorkingSetBytes</b> metric data from Azure API Server (https://management.azure.com/). The metric is container App working set memory used in bytes.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: WorkingSetBytes
* <b>NetBrain Display Name</b>: Working Set Bytes
* <b>Unit</b>: Bytes
