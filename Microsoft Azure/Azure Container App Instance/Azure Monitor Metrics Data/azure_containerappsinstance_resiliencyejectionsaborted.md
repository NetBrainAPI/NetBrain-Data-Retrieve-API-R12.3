...
The API is used to retrieve Azure Container App Instance <b>ResiliencyEjectionsAborted</b> metric data from Azure API Server (https://management.azure.com/). The metric is the number of ejections aborted due to the max ejection %.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.


# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: ResiliencyEjectionsAborted
* <b>NetBrain Display Name</b>: Resiliency Ejected Aborted
* <b>Unit</b>: Count
