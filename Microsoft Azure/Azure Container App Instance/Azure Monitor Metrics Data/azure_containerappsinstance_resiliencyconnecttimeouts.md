...
The API is used to retrieve Azure Container App Instance <b>ResiliencyConnectTimeouts</b> metric data from Azure API Server (https://management.azure.com/). The metric is the total connection timeouts.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.


# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: ResiliencyConnectTimeouts
* <b>NetBrain Display Name</b>: Resiliency Connect Timeouts
* <b>Unit</b>: Count
