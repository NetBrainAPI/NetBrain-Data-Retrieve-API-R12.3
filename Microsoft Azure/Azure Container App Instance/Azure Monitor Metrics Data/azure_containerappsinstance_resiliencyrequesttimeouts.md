...
The API is used to retrieve Azure Container App Instance <b>ResiliencyRequestTimeouts</b> metric data from Azure API Server (https://management.azure.com/). The metric is the total request that timed out waiting for a response.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: ResiliencyRequestTimeouts
* <b>NetBrain Display Name</b>: Resiliency Request Timeouts
* <b>Unit</b>: Count
