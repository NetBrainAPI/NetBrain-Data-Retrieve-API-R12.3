...
The API is used to retrieve Azure Container App Instance <b>MemoryPercentage</b> metric data from Azure API Server (https://management.azure.com/). The metric is the percentage of memory limit used, in percentage points.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: MemoryPercentage
* <b>NetBrain Display Name</b>: Memory Percentage
* <b>Unit</b>: Percent
