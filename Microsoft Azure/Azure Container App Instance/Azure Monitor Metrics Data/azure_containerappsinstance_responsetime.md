...
The API is used to retrieve Azure Container App Instance <b>ResponseTime</b> metric data from Azure API Server (https://management.azure.com/). The metric is the average Response Time per Status Code. The Unit is Milliseconds. The Aggregation Types are Average, Total (Sum), Maximum and Minimum. Time Grain (Intervals at which the metric is sampled) is PT1M(Every 1 minute). The Azure monitor metrics original name: ResponseTime.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: ResponseTime
* <b>NetBrain Display Name</b>: Response Time
