...
The API is used to retrieve Azure Container App Instance <b>RestartCount</b> metric data from Azure API Server (https://management.azure.com/). The metric is the cumulative number of times the replica has restarted since it was created.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: RestartCount
* <b>NetBrain Display Name</b>: Restart Count
* <b>Unit</b>: Count
