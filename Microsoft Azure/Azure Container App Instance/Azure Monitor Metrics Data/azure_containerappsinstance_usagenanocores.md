...
The API is used to retrieve Azure Container App Instance <b>UsageNanoCores</b> metric data from Azure API Server (https://management.azure.com/). The metric is CPU consumed by the container app, in nano cores.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: UsageNanoCores
* <b>NetBrain Display Name</b>: Usage Nano Cores
* <b>Unit</b>: NanoCores
