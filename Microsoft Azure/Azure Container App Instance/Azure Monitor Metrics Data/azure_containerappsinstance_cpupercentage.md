...
The API is used to retrieve Azure Container App Instance <b>CpuPercentage</b> metric data from Azure API Server (https://management.azure.com/). The metric is the percentage of CPU limit used in percentage points.
