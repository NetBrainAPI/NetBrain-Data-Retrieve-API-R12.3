...
The API is used to retrieve Azure Container App Instance <b>Replicas</b> metric data from Azure API Server (https://management.azure.com/). The metric is the number of replicas count of container app.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: Replicas
* <b>NetBrain Display Name</b>: Replica Count
* <b>Unit</b>: Count
