...
The API is used to retrieve Azure Container App Instance <b>TotalCoresQuotaUsed</b> metric data from Azure API Server (https://management.azure.com/). The metric is the number of total reserved cores for the container app. The Unit is Count. The Aggregation Types are Average, Maximum and Minimum. Time Grain (Intervals at which the metric is sampled) is PT1M(Every 1 minute). The Azure monitor metrics original name: TotalCoresQuotaUsed.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: TotalCoresQuotaUsed
* <b>NetBrain Display Name</b>: Total Reserved Cores
* <b>Unit</b>: Count
