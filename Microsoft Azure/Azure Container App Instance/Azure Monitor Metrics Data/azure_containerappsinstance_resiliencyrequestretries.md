...
The API is used to retrieve Azure Container App Instance <b>ResiliencyRequestRetries</b> metric data from Azure API Server (https://management.azure.com/). The metric is the total request retries.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.


# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: ResiliencyRequestRetries
* <b>NetBrain Display Name</b>: Resiliency Request Retries
* <b>Unit</b>: Count
