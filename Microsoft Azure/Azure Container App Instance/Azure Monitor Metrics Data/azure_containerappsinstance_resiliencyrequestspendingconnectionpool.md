...
The API is used to retrieve Azure Container App Instance <b>ResiliencyRequestsPendingConnectionPool</b> metric data from Azure API Server (https://management.azure.com/). The metric is the total requests pending a connection pool connection.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: ResiliencyRequestsPendingConnectionPool
* <b>NetBrain Display Name</b>: Resiliency Requests Pending Connection Pool
* <b>Unit</b>: Count
