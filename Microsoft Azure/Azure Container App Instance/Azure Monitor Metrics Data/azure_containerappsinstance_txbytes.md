...
The API is used to retrieve Azure Container App Instance <b>TxBytes</b> metric data from Azure API Server (https://management.azure.com/). The metric is network transmitted bytes.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: TxBytes
* <b>NetBrain Display Name</b>: Network Out Bytes
* <b>Unit</b>: Bytes
