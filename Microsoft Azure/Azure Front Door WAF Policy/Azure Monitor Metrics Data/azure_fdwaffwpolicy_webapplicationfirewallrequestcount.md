...
The API is used to retrieve Azure Front Door WAF Policies <b>WebApplicationFirewallRequestCount</b> metric data from Azure API Server (https://management.azure.com/). The metric is the number of client requests processed by the Web Application Firewall.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.


# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: WebApplicationFirewallRequestCount 
* <b>NetBrain Display Name</b>: Web Application Firewall Request Count
* <b>Unit</b>: Count
...
* <b>Metrics Details</b>: https://learn.microsoft.com/en-us/azure/azure-monitor/reference/supported-metrics/microsoft-cdn-cdnwebapplicationfirewallpolicies-metrics
