...
The API is used to retrieve Azure SQL Managed Instance <b>io_requests</b> metric data from Azure API Server (https://management.azure.com/). The metric is IO requests count.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: io_requests
* <b>NetBrain Display Name</b>: IO Requests Count
* <b>Unit</b>: Count
