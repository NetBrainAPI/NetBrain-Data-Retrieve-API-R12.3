...
The API is used to retrieve Azure SQL Managed Instance <b>storage_space_used_mb</b> metric data from Azure API Server (https://management.azure.com/). The metric is storage space used.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: storage_space_used_mb
* <b>NetBrain Display Name</b>: Storage Space Used
* <b>Unit</b>: Count
