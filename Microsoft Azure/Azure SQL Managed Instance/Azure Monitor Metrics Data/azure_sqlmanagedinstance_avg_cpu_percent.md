...
The API is used to retrieve Azure SQL Managed Instance <b>avg_cpu_percent</b> metric data from Azure API Server (https://management.azure.com/). The metric is average CPU percentage.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: avg_cpu_percent
* <b>NetBrain Display Name</b>: Average CPU Percentage
* <b>Unit</b>: Percent
