...
The API is used to retrieve Azure SQL Managed Instance <b>virtual_core_count</b> metric data from Azure API Server (https://management.azure.com/). The metric is virtual core count.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: virtual_core_count
* <b>NetBrain Display Name</b>: Virtual Core Count
* <b>Unit</b>: Count
