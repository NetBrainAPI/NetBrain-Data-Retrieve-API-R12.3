...
The API is used to retrieve Azure SQL Managed Instance <b>reserved_storage_mb</b> metric data from Azure API Server (https://management.azure.com/). The metric is storage space reserved.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: reserved_storage_mb
* <b>NetBrain Display Name</b>: Storage Space Reserved
* <b>Unit</b>: Count
...
* <b>Metrics Details</b>: https://learn.microsoft.com/en-us/azure/azure-monitor/reference/supported-metrics/microsoft-sql-managedinstances-metrics
