...
The API is used to retrieve Azure SQL Managed Instance <b>io_bytes_read</b> metric data from Azure API Server (https://management.azure.com/). The metric is IO bytes read.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: io_bytes_read
* <b>NetBrain Display Name</b>: IO Bytes Read
* <b>Unit</b>: Bytes
