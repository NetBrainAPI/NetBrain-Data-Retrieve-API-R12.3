...
The API is used to retrieve Azure DNS Resolver Instance <b>InboundEndpointCount</b> metric data from Azure API Server (https://management.azure.com/). The metric is to indicate the number of inbound endpoints created for a DNS Resolver.

It leverages the Azure Monitor solution to fetch metrics of Azure resources via the Azure RESTful API.

# Metric Info <a name="metric-info"></a>
* <b>Azure REST API Name</b>: InboundEndpointCount
* <b>NetBrain Display Name</b>: Inbound Endpoint Count
* <b>Unit</b>: Count
